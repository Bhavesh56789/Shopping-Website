...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light nav1">
    ...
    <a class="navbar-brand" href="./Home/index.php">EPORT<i class="fas fa-shopping-bag log"></i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-lg-5 ">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo "./cart/cart.php?session=" . false; ?>"><i class='fas fa-shopping-cart'
              style='font-size:18px;color:white;padding-top:2px'></i>Cart</a>
        </li>
      </ul>
            ...
            <div class="dropdown-menu dropdown-multicol2" aria-labelledby="dropdownMenuButton">
              <div class="dropdown-col">
                ...
                <b class='dropdown-item categ h1'><a class="h1"
                    href="<?php echo "./product.php?user='Mobile'&session=" . false;  ?>">Mobiles</a></b>
                <a class='dropdown-item categ h2'
                  href="<?php echo "./product.php?user='Redmi'&session=" . false; ?>">Mi</a>
                <a class='dropdown-item categ h2'
                  href="<?php echo "./product.php?user='Samsung'&session=" . false; ?>">Samsung</a>
